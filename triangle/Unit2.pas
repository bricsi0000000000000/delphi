...
begin
  ...
  if Length(OppositeSideEdit.Text) = 0 then
  begin
    inputGood := false;
    ShowMessage('You have to give a value for opposite side!');
  end
  ...
  if Length(AdjacentSideEdit.Text) = 0 then
  begin
    inputGood := false;
    ShowMessage('You have to give a value for adjacent side!');
  end
